package com.example.weatheryou.adapter
...
import com.example.weatheryou.R
...
class WeatherToday : RecyclerView.Adapter<TodayHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TodayHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.todayforecastlist, parent, false)
